...
namespace Transpose.Core
{
    public  static partial class es5
    {
        ...
        [FormerInterface]
        public class Float32Array : IList<float>, ICollection<float>, IEnumerable<float>, IEnumerable, ITransposeClass, IReadOnlyList<float>, IReadOnlyCollection<float>, ICollection, IObject
        {
