...
namespace Transpose.Core
{
    public  static partial class es5
    {
        ...
        [FormerInterface]
        public class Uint8Array : IList<byte>, ICollection<byte>, IEnumerable<byte>, IEnumerable, ITransposeClass, IReadOnlyList<byte>, IReadOnlyCollection<byte>, ICollection, IObject
        {
