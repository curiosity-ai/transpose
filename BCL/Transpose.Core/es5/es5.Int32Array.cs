...
namespace Transpose.Core
{
    public  static partial class es5
    {
        ...
        [FormerInterface]
        public class Int32Array : IList<int>, ICollection<int>, IEnumerable<int>, IEnumerable, ITransposeClass, IReadOnlyList<int>, IReadOnlyCollection<int>, ICollection, IObject
        {
