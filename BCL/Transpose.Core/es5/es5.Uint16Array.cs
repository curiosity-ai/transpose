...
namespace Transpose.Core
{
    public  static partial class es5
    {
        ...
        [FormerInterface]
        public class Uint16Array : IList<ushort>, ICollection<ushort>, IEnumerable<ushort>, IEnumerable, ITransposeClass, IReadOnlyList<ushort>, IReadOnlyCollection<ushort>, ICollection, IObject
        {
