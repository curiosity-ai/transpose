...
namespace Transpose.Core
{
    public  static partial class es5
    {
        ...
        [FormerInterface]
        public class Uint32Array : IList<uint>, ICollection<uint>, IEnumerable<uint>, IEnumerable, ITransposeClass, IReadOnlyList<uint>, IReadOnlyCollection<uint>, ICollection, IObject
        {
