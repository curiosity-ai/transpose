    ...
    System.Decimal = function (v, provider, T) {
        ...
        if (Transpose.isNumber(provider)) {
    ...
    Transpose.Class.addExtend(System.Decimal, [System.IComparable, System.IFormattable, System.IComparable$1(System.Decimal), System.IEquatable$1(System.Decimal)]);
    ...
    System.Decimal.getValue = function (d) {
        ...
        if (d instanceof System.Int64 || d instanceof System.UInt64) {
            return new Transpose.$Decimal(d.toString());
        }

        return new Transpose.$Decimal(d);
    };
    ...
    System.Decimal.prototype.toString = function (format, provider) {
        return Transpose.Int.format(this, format || "G", provider);
    };
    ...
    System.Decimal.prototype.format = function (format, provider) {
        return Transpose.Int.format(this, format, provider);
    };
    ...
    System.Decimal.round = function (obj, mode) {
        ...
        var old = Transpose.$Decimal.rounding;

        Transpose.$Decimal.rounding = mode;

        var d = new System.Decimal(obj.value.round());

        Transpose.$Decimal.rounding = old;
    ...
    System.Decimal.toInt = function (v, tp) {
        ...
        if (tp) {
            ...
            return Transpose.Int.check(Transpose.Int.trunc(v.value.toNumber()), tp);
        }

        var i = Transpose.Int.trunc(System.Decimal.getValue(v).toNumber());

        if (!Transpose.Int.$is(i)) {
            throw new System.OverflowException();
        }
    ...
    System.Decimal.setConfig = function (config) {
        Transpose.$Decimal.config(config);
    };
    ...
    System.Decimal.min = function () {
        ...
        d = Transpose.$Decimal.min.apply(Transpose.$Decimal, values);
    ...
    System.Decimal.max = function () {
        ...
        d = Transpose.$Decimal.max.apply(Transpose.$Decimal, values);
    ...
    System.Decimal.random = function (dp) {
        return new System.Decimal(Transpose.$Decimal.random(dp));
    };
    ...
    System.Decimal.prototype.toFormat = function (dp, rm, provider) {
        ...
        if (provider && !provider.getFormat) {
            config = Transpose.merge(config, provider);
    ...
    System.Decimal.fromBytes = function (bytes) {
        var value = new System.Decimal(0),
            s = Transpose.Int.sxb(bytes[0] & 255),
            e = bytes[1],
            ln = bytes[2],
            d = [];
    ...
    Transpose.$Decimal.config({ precision: 29 });
