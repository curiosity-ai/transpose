    Transpose.Math = {
        ...
        logWithBase: function (x, newBase) {
            ...
            return Transpose.Math.log10(x) / Transpose.Math.log10(newBase);
        },
        ...
        IEEERemainder: function (x, y) {
            ...
            alternativeResult = regularMod - (Math.abs(y) * Transpose.Int.sign(x));
            if (Math.abs(alternativeResult) === Math.abs(regularMod)) {
                var divisionResult = x / y;
                var roundedResult = Transpose.Math.round(divisionResult, 0, 6);
