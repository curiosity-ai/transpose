    Transpose.define("System.Collections.Generic.Comparer$1", function (T) {
        return {
            ...
            ctor: function (fn) {
                ...
                this.fn = fn;
                this.compare = fn;
                this["System$Collections$Generic$IComparer$1$" + Transpose.getTypeAlias(T) + "$compare"] = fn;
    ...
    System.Collections.Generic.Comparer$1.get = function (obj, T) {
        ...
        if (T && (m = obj["System$Collections$Generic$IComparer$1$" + Transpose.getTypeAlias(T) + "$compare"])) {
            return m.bind(obj);
        }
