...
namespace System {
    ...
    public struct DateTime : IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime>,IEquatable<DateTime> {
        ...
        public Boolean IsDaylightSavingTime() {
            ...
            // TODO: Revised [calculate IsDaylightSavingTime]
            var isDST = false;
            var ticks = this.ToUniversalTime().Ticks;
            ...
            /*@
                ...
                isDST = temp.getTimezoneOffset() !== new Date(ticks.sub(System.Int64("621355968000000000"))).getTimezoneOffset();
            */
        ...
        public static DateTime UtcNow {
            ...
            get {
                ...
                /*@
                    var d = new Date();
                    var d2 = new Date(d.getUTCFullYear(), d.getUTCMonth(), d.getUTCDate(), d.getUTCHours(), d.getUTCMinutes(), d.getUTCSeconds(), d.getUTCMilliseconds());
                    ticks = System.Int64(d2.getTime()).add(System.Int64("621355968000000000"));
                */
        ...
        public String ToString(String format) {
            Contract.Ensures(Contract.Result<String>() != null);
            return this.ToString(format, DateTimeFormatInfo.CurrentInfo);
            // TODO: Revised []
