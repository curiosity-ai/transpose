...
namespace System
{
    ...
    public sealed class String : IEnumerable, ICloneable, IEnumerable<char>, IComparable<string>, IEquatable<string>
    {
        ...
        [Transpose.Template("System.String.fromCharArray({value})")]
        ...
        [Transpose.Template("System.String.fromCharCount({c}, {count})")]
        ...
        [Transpose.Template("System.String.isNullOrEmpty({value})")]
        ...
        [Transpose.Template("System.String.isNullOrWhiteSpace({value})")]
        ...
        [Transpose.Template("System.String.equals({a}, {b})")]
        ...
        /// <returns>true if the value of a is the same as the value of b; otherwise, false. If both a and b are null, the method returns true.</returns>
        [Transpose.Template("System.String.equals({a}, {b}, {comparisonType})")]
        ...
        [Transpose.Template("System.String.equals({this}, {value}, {comparisonType})")]
        ...
        /// <param name="value">The string to compare to this instance.</param>
        /// <returns>true if the value of the value parameter is the same as this string; otherwise, false.</returns>
        [Transpose.Template("System.String.equals({this}, {value})")]
        ...
        /// <returns></returns>
        [Transpose.Template("System.String.concat({str0}, {str1})")]
        ...
        /// <returns></returns>
        [Transpose.Template("System.String.concat({str0}, {str1}, {str2})")]
        ...
        /// <returns></returns>
        [Transpose.Template("System.String.concat({str0}, {str1}, {str2}, {str3})")]
        ...
        [Transpose.Template("System.String.concat({values:array})")]
        ...
        [Transpose.Template("System.String.concat({arg0})")]
        ...
        [Transpose.Template("System.String.concat({arg0}, {arg1})")]
        ...
        [Transpose.Template("System.String.concat({arg0}, {arg1}, {arg2})")]
        ...
        [Transpose.Template("System.String.concat({arg0}, {arg1}, {arg2}, {arg3})")]
        ...
        /// <returns>The concatenated string representation of each value in the parameter list.</returns>
        [Transpose.Template("System.String.concat({arg0}, {arg1}, {arg2}, {arg3}, {*args})")]
        ...
        [Transpose.Template("System.String.concat({args:array})")]
        ...
        [Transpose.Template("System.String.compare({strA}, {strB})")]
        ...
        /// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
        [Transpose.Template("System.String.compare({strA}, {strB}, {ignoreCase})")]
        ...
        [Transpose.Template("System.String.compare({strA}.substr({indexA}, {length}), {strB}.substr({indexB}, {length}))")]
        ...
        /// <param name="ignoreCase">true to ignore case during the comparison; otherwise, false.</param>
        /// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
        [Transpose.Template("System.String.compare({strA}.substr({indexA}, {length}), {strB}.substr({indexB}, {length}), {ignoreCase})")]
        ...
        /// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
        [Transpose.Template("System.String.compare({strA}, {strB}, {comparisonType})")]
        ...
        /// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
        [Transpose.Template("System.String.compare({strA}, {strB}, {ignoreCase}, {culture})")]
        ...
        /// <param name="comparisonType">One of the enumeration values that specifies the rules to use in the comparison.</param>
        /// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
        [Transpose.Template("System.String.compare({strA}.substr({indexA}, {length}), {strB}.substr({indexB}, {length}), {comparisonType})")]
        ...
        [Transpose.Template("System.String.compare({strA}.substr({indexA}, {length}), {strB}.substr({indexB}, {length}), {ignoreCase}, {culture})")]
        ...
        [Transpose.Template("System.String.indexOf({this}, String.fromCharCode({value}))")]
        ...
        [Transpose.Template("System.String.indexOf({this}, String.fromCharCode({value}), {startIndex})")]
        ...
        [Transpose.Template("System.String.indexOf({this}, {value})")]
        ...
        [Transpose.Template("System.String.indexOf({this}, {value}, {startIndex})")]
        ...
        /// <returns></returns>
        [Transpose.Template("System.String.indexOf({this}, String.fromCharCode({value}), {startIndex}, {count})")]
        ...
        /// <param name="count">The number of character positions to examine.</param>
        /// <returns></returns>
        [Transpose.Template("System.String.indexOf({this}, {searchValue}, {fromIndex}, {count})")]
        ...
        [Transpose.Template("System.String.indexOf({this}, {value}, 0, null, {comparisonType})")]
        ...
        [Transpose.Template("System.String.indexOf({this}, {value}, {startIndex}, null, {comparisonType})")]
        ...
        /// <param name="comparisonType">One of the enumeration values that specifies the rules for the search.</param>
        /// <returns>The zero-based index position of the value parameter from the start of the current instance if that string is found, or -1 if it is not. If value is Empty, the return value is startIndex.</returns>
        [Transpose.Template("System.String.indexOf({this}, {value}, {startIndex}, {count}, {comparisonType})")]
        ...
        [Transpose.Template("System.String.lastIndexOfAny({this}, {anyOf:array})")]
        ...
        [Transpose.Template("System.String.lastIndexOfAny({this}, {anyOf}, {startIndex})")]
        ...
        /// <param name="count">The number of character positions to examine.</param>
        /// <returns>The index position of the last occurrence in this instance where any character in anyOf was found; -1 if no character in anyOf was found or if the current instance equals String.Empty.</returns>
        [Transpose.Template("System.String.lastIndexOfAny({this}, {anyOf}, {startIndex}, {count})")]
        ...
        [Transpose.Template("System.String.replaceAll({this}, String.fromCharCode({oldChar}), String.fromCharCode({newChar}))")]
        ...
        [Transpose.Template("System.String.replaceAll({this}, {oldValue}, {newValue})")]
        ...
        [Transpose.Template("System.String.split({this}, {separator:array}.map(function (i) {{ return String.fromCharCode(i); }}))")]
        ...
        [Transpose.Template("System.String.split({this}, {separator}.map(function (i) {{ return String.fromCharCode(i); }}), {count})")]
        ...
        [Transpose.Template("System.String.split({this}, {separator}.map(function (i) {{ return String.fromCharCode(i); }}), {count}, {options})")]
        ...
        /// <param name="options">StringSplitOptions.RemoveEmptyEntries to omit empty array elements from the array returned; or StringSplitOptions.None to include empty array elements in the array returned.</param>
        /// <returns>An array whose elements contain the substrings in this string that are delimited by one or more characters in separator. For more information, see the Remarks section.</returns>
        [Transpose.Template("System.String.split({this}, {separator}.map(function (i) {{ return String.fromCharCode(i); }}), null, {options})")]
        ...
        [Transpose.Template("System.String.split({this}, {separator}, {count}, {options})")]
        ...
        /// <param name="options">StringSplitOptions.RemoveEmptyEntries to omit empty array elements from the array returned; or StringSplitOptions.None to include empty array elements in the array returned.</param>
        /// <returns>An array whose elements contain the substrings in this string that are delimited by one or more strings in separator. For more information, see the Remarks section.</returns>
        [Transpose.Template("System.String.split({this}, {separator}, null, {options})")]
        ...
        [Transpose.Template("System.String.trim({this}, {trimChars:array})")]
        ...
        [Transpose.Template("System.String.trimEnd({this})")]
        ...
        /// <param name="trimChars">An array of Unicode characters to remove, or null.</param>
        /// <returns>The string that remains after all occurrences of the characters in the trimChars parameter are removed from the end of the current string. If trimChars is null or an empty array, Unicode white-space characters are removed instead. If no characters can be trimmed from the current instance, the method returns the current instance unchanged.</returns>
        [Transpose.Template("System.String.trimEnd({this}, {trimChars:array})")]
        ...
        [Transpose.Template("System.String.trimStart({this})")]
        ...
        /// <param name="trimChars">An array of Unicode characters to remove, or null.</param>
        /// <returns>The string that remains after all occurrences of characters in the trimChars parameter are removed from the start of the current string. If trimChars is null or an empty array, white-space characters are removed instead.</returns>
        [Transpose.Template("System.String.trimStart({this}, {trimChars:array})")]
        ...
        [Transpose.Template("System.String.contains({this},{value})")]
        ...
        [Transpose.Template("System.String.endsWith({this}, {value})")]
        ...
        /// <returns>true if value matches the end of this instance; otherwise, false.</returns>
        [Transpose.Template("System.String.endsWith({this}, {value}, {comparisonType})")]
        ...
        [Transpose.Template("System.String.startsWith({this}, {value})")]
        public extern bool StartsWith(string value);

        /// <summary>
        /// Determines whether the beginning of this string instance matches the specified string.
        /// </summary>
        [Transpose.Template("System.String.startsWith({this}, {value}, {comparisonType})")]
        ...
        [Transpose.Template("System.String.formatProvider({provider}, {format}, [{arg0}])")]
        ...
        [Transpose.Template("System.String.formatProvider({provider}, {format}, {arg0}, {arg1})")]
        [Transpose.Unbox(false)]
        ...
        [Transpose.Template("System.String.formatProvider({provider}, {format}, {arg0}, {arg1}, {arg2})")]
        [Transpose.Unbox(false)]
        ...
        [Transpose.Template("System.String.formatProvider({provider}, {format}, {args})")]
        [Transpose.Unbox(false)]
        ...
        [Transpose.Template("System.String.format({format}, [{arg0}])")]
        [Transpose.Unbox(false)]
        ...
        /// <param name="arg1">The second object to format.</param>
        /// <returns>A copy of format in which format items are replaced by the string representations of arg0 and arg1.</returns>
        [Transpose.Template("System.String.format({format}, {arg0}, {arg1})")]
        [Transpose.Unbox(false)]
        ...
        /// <param name="arg2">The third object to format.</param>
        /// <returns>A copy of format in which the format items have been replaced by the string representations of arg0, arg1, and arg2.</returns>
        [Transpose.Template("System.String.format({format}, {arg0}, {arg1}, {arg2})")]
        [Transpose.Unbox(false)]
        ...
        /// <param name="args">An object array that contains zero or more objects to format.</param>
        /// <returns>A copy of format in which the format items have been replaced by the string representation of the corresponding objects in args.</returns>
        [Transpose.Template("System.String.format({format}, {args})")]
        [Transpose.Unbox(false)]
        ...
        [Transpose.Template("System.String.indexOfAny({this}, {anyOf})")]
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns></returns>
        [Transpose.Template("System.String.indexOfAny({this}, {anyOf}, {startIndex})")]
        ...
        /// <param name="count">The number of character positions to examine.</param>
        /// <returns>The zero-based index position of the first occurrence in this instance where any character in anyOf was found; -1 if no character in anyOf was found.</returns>
        [Transpose.Template("System.String.indexOfAny({this}, {anyOf}, {startIndex}, {count})")]
        ...
        [Transpose.Template("System.String.toCharArray({this}, 0, {this}.length)")]
        ...
        [Transpose.Template("System.String.toCharArray({this}, {startIndex}, {length})")]
        ...
        {
            [Transpose.External]
            [Transpose.Template("charCodeAt({0})")]
            get;
        }
        ...
        [Transpose.Template("System.String.compare({this}, {value}.toString())")]
        ...
        [Transpose.Template("System.String.compare({this}, {strB})")]
        ...
        [Transpose.Template("System.String.insert({startIndex}, {this}, {value})")]
        ...
        [Transpose.Template("System.String.alignString({this}, {totalWidth})")]
        ...
        [Transpose.Template("System.String.alignString({this}, {totalWidth}, {paddingChar})")]
        ...
        [Transpose.Template("System.String.remove({this}, {startIndex})")]
        ...
        [Transpose.Template("System.String.remove({this}, {startIndex}, {count})")]
        ...
        [Transpose.Template("System.String.copyTo({this}, {sourceIndex}, {destination}, {destinationIndex}, {count})")]
