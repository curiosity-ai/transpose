...
namespace System
{
    ...
    public struct DateTime : IComparable, IComparable<DateTime>, IEquatable<DateTime>, IFormattable
    {
        ...
        [Transpose.Template("System.DateTime.TicksPerDay")]
        private const long TicksPerDay = 864000000000;

        [Transpose.Template("System.DateTime.DaysTo1970")]
        internal const int DaysTo1970 = 719162;

        [Transpose.Template("System.DateTime.getMinTicks()")]
        internal const long MinTicks = 0;

        [Transpose.Template("System.DateTime.getMaxTicks()")]
        ...
        /// </summary>
        [Transpose.Template("System.DateTime.getMaxValue()")]
        public static readonly DateTime MaxValue;

        /// <summary>
        /// Represents the smallest possible value of DateTime. This field is read-only.
        /// </summary>
        [Transpose.Template("System.DateTime.getMinValue()")]
        public static readonly DateTime MinValue;

        /// <summary>
        /// Initializes a new instance of the DateTime structure.
        /// </summary>
        [Transpose.Template("System.DateTime.getDefaultValue()")]
        ...
        [Transpose.Template("System.DateTime.create$2({0})")]
        ...
        [Transpose.Template("System.DateTime.create$2({0}, {1})")]
        ...
        [Transpose.Template("System.DateTime.create({0}, {1}, {2})")]
        ...
        [Transpose.Template("System.DateTime.create({0}, {1}, {2}, {3}, {4}, {5})")]
        ...
        [Transpose.Template("System.DateTime.create({0}, {1}, {2}, {3}, {4}, {5}, 0, {6})")]
        ...
        [Transpose.Template("System.DateTime.create({0}, {1}, {2}, {3}, {4}, {5}, {6})")]
        ...
        /// <param name="millisecond">The milliseconds (0 through 999).</param>
        /// <param name="kind">One of the enumeration values that indicates whether year, month, day, hour, minute, second, and millisecond specify a local time, Coordinated Universal Time (UTC), or neither.</param>
        [Transpose.Template("System.DateTime.create({0}, {1}, {2}, {3}, {4}, {5}, {6}, {7})")]
        ...
        {
            [Transpose.Template("System.DateTime.getToday()")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getNow()")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getUtcNow()")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getKind({this})")]
            get;
        }
        ...
        [Transpose.Template("System.DateTime.specifyKind({0}, {1})")]
        ...
        [Transpose.Template("System.DateTime.FromFileTime({0})")]
        ...
        /// <param name="fileTime">Ticks</param>
        /// <returns>DateTime</returns>
        [Transpose.Template("System.DateTime.FromFileTimeUtc({0})")]
        public extern static DateTime FromFileTimeUtc(long fileTime);

        [Transpose.Template("System.DateTime.ToFileTime({this})")]
        ...
        [Transpose.Template("System.DateTime.format({this}, {0}, {1})")]
        public extern string ToString(string format, IFormatProvider provider);

        [Transpose.Template("System.DateTime.parse({0})")]
        public static extern DateTime Parse(string s);

        [Transpose.Template("System.DateTime.parse({0}, {1})")]
        public static extern DateTime Parse(string s, IFormatProvider provider);

        [Transpose.Template("System.DateTime.tryParse({0}, null, {1})")]
        public static extern bool TryParse(string s, out DateTime result);

        [Transpose.Template("System.DateTime.parseExact({0}, {1}, {2})")]
        public static extern DateTime ParseExact(string s, string format, IFormatProvider provider);

        [Transpose.Template("System.DateTime.tryParseExact({0}, {1}, {2}, {3})")]
        public static extern bool TryParseExact(string s, string format, IFormatProvider provider, out DateTime result);

        [Transpose.Template("System.DateTime.subdt({0}, {1})")]
        public static extern DateTime operator -(DateTime d, TimeSpan t);

        [Transpose.Template("System.DateTime.adddt({0}, {1})")]
        public static extern DateTime operator +(DateTime d, TimeSpan t);

        [Transpose.Template("System.DateTime.subdd({0}, {1})")]
        public static extern TimeSpan operator -(DateTime a, DateTime b);

        [Transpose.Template("System.DateTime.subdd({this}, {0})")]
        public extern TimeSpan Subtract(DateTime value);

        [Transpose.Template("Transpose.equals({0}, {1})")]
        public static extern bool operator ==(DateTime a, DateTime b);

        [Transpose.Template("!Transpose.equals({0}, {1})")]
        public static extern bool operator !=(DateTime a, DateTime b);

        [Transpose.Template("System.DateTime.lt({0}, {1})")]
        public static extern bool operator <(DateTime a, DateTime b);

        [Transpose.Template("System.DateTime.gt({0}, {1})")]
        public static extern bool operator >(DateTime a, DateTime b);

        [Transpose.Template("System.DateTime.lte({0}, {1})")]
        public static extern bool operator <=(DateTime a, DateTime b);

        [Transpose.Template("System.DateTime.gte({0}, {1})")]
        public static extern bool operator >=(DateTime a, DateTime b);
        ...
        {
            [Transpose.Template("System.DateTime.getDate({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getDayOfYear({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getDayOfWeek({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getYear({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getMonth({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getDay({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getHour({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getMillisecond({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getMinute({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getSecond({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getTimeOfDay({this})")]
            get;
        }
        ...
        {
            [Transpose.Template("System.DateTime.getTicks({this})")]
            get;
        }
        ...
        [Transpose.Template("System.DateTime.addYears({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addMonths({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addDays({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addHours({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addMinutes({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addSeconds({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addMilliseconds({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.addTicks({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.add({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.subtract({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.getDaysInMonth({0}, {1})")]
        ...
        [Transpose.Template("System.DateTime.getIsLeapYear({0})")]
        ...
        [Transpose.Template("Transpose.compare({t1}, {t2})")]
        public static extern int Compare(DateTime t1, DateTime t2);

        [Transpose.Template("Transpose.equalsT({this}, {0})")]
        public extern bool Equals(DateTime other);

        [Transpose.Template("Transpose.equalsT({0}, {1})")]
        ...
        [Transpose.Template("System.DateTime.isDaylightSavingTime({this})")]
        ...
        [Transpose.Template("System.DateTime.toUniversalTime({this})")]
        ...
        [Transpose.Template("System.DateTime.toLocalTime({this})")]
        ...
        /// </summary>
        /// <returns>An object whose Kind property is Local, and whose value is the local time equivalent to the value of the current DateTime object, or MaxValue if the converted value is too large to be represented by a DateTime object, or MinValue if the converted value is too small to be represented as a DateTime object.</returns>
        [Transpose.Template("System.DateTime.toLocalTime({this}, {0})")]
        ...
        [Transpose.Template("System.DateTime.format({this}, \"d\")")]
        ...
        [Transpose.Template("System.DateTime.format({this}, \"t\")")]
