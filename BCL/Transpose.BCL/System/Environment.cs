...
namespace System
{
    ...
    /// Some methods have Transpose implementation that differ from .Net.
    /// </summary>
    public static class Environment
    {
        ...
        {
            [Transpose.Template("Transpose.global")]
            get;
        }
        ...
        /// The Transpose implementation returns location.pathname + " " + location.search
        /// </summary>
        ...
        /// The Transpose implementation controls window.location.pathname.
        /// </summary>
        ...
        /// The Transpose implementation returns zero.
        /// </summary>
        ...
        /// The Transpose implementation returns false.
        /// </summary>
        ...
        /// The Transpose implementation returns an empty string.
        /// </summary>
        ...
        /// The Transpose implementation returns "\n".
        /// </summary>
        ...
        /// <summary>
        /// The Transpose implementation returns null.
        /// </summary>
        public static object OSVersion
        {
            [Transpose.Template("null")]
            get;
        }

        /// <summary>
        /// Gets the number of processors on the current machine.
        /// The Transpose implementation returns navigator.hardwareConcurrency if exists, otherwise 1.
        /// </summary>
        ...
        public static string StackTrace
        {
            get
            {
                var err = Transpose.Script.Write<dynamic>("new Error()");
                string s = err.stack;
        ...
        /// The Transpose implementation returns 1.
        /// </summary>
        public static int SystemPageSize
        {
            [Transpose.Template("1")]
            get;
        }

        /// <summary>
        /// Gets the number of milliseconds elapsed since the system started.
        /// The Transpose implementation returns the number of milliseconds elapsed since 1 January 1970 00:00:00 UTC.
        /// </summary>
        public static int TickCount
        {
            [Transpose.Template("Date.now()")]
            get;
        }
        ...
        /// The Transpose implementation returns true;
        /// </summary>
        public static bool UserInteractive
        {
            [Transpose.Template("true")]
            get;
        }
        ...
        /// The Transpose implementation returns Transpose Compiler version.
        /// </summary>
        public static Version Version
        {
            get
            {
                var s = Transpose.Utils.SystemAssembly.Assembly.CompilerVersionString;
        ...
        {
            [Transpose.Template("System.Int64(0)")]
            get;
        }

        /// <summary>
        /// Terminates this process and returns an exit code to the operating system.
        /// The Transpose implementation just sets ExitCode.
        /// </summary>
        ...
        /// The Transpose implementation throws an exception with the message specified. Note it will run finally block if any.
        /// </summary>
        ...
        /// </summary>
        /// <returns>The Transpose implementation returns location.pathname and query parameters.</returns>
        ...
        /// <param name="target">Ignored by Transpose. One of the EnvironmentVariableTarget values.</param>
        /// <returns>The Transpose implementation ignores target. The value of the environment variable specified by variable, or null if the environment variable is not found.</returns>
        ...
        /// <returns>The Transpose implementation ignores target. A dictionary that contains all environment variable names and their values; otherwise, an empty dictionary if no environment variables are found.</returns>
        ...
        /// <returns>The Transpose implementation returns an empty string.</returns>
        [Transpose.Template("\"\"")]
        ...
        /// <param name="variable">The name of an environment variable.</param>
        /// <param name="value">A value to assign to variable.</param>
        /// <param name="target">Ignored by Transpose. One of the enumeration values that specifies the location of the environment variable.</param>
