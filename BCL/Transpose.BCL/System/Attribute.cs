...
namespace System
{
    ...
    [Transpose.External]
    [Transpose.Name("System.Attribute")]
    [AttributeUsageAttribute(AttributeTargets.All, Inherited = true, AllowMultiple = false)]
    public class Attribute : Transpose.ITransposeClass
    {
        ...
        [Transpose.Template("System.Attribute.getCustomAttributes$1({element}, false)")]
        ...
        /// <returns>An Attribute array that contains the custom attributes applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes$1({element}, false, {inherit})")]
        ...
        [Transpose.Template("System.Attribute.getCustomAttributes$1({element}, {attributeType})")]
        ...
        /// <param name="inherit">This parameter is ignored, and does not affect the operation of this method.</param>
        /// <returns>An Attribute array that contains the custom attributes of type attributeType applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes$1({element}, {attributeType}, {inherit})")]
        ...
        /// <returns>An Attribute array that contains the custom attributes applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, false)")]
        ...
        /// <returns>An Attribute array that contains the custom attributes applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, false, {inherit})")]
        ...
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, {type})")]
        ...
        /// <param name="inherit">If true, specifies to also search the ancestors of element for custom attributes.</param>
        /// <returns>An Attribute array that contains the custom attributes of type type applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, {type}, {inherit})")]
        ...
        /// <param name="attributeType">The type, or a base type, of the custom attribute to search for.</param>
        /// <returns>An Attribute array that contains the custom attributes of type attributeType applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, {attributeType})")]
        ...
        /// <param name="inherit">If true, specifies to also search the ancestors of element for custom attributes.</param>
        /// <returns>An Attribute array that contains the custom attributes of type attributeType applied to element, or an empty array if no such custom attributes exist.</returns>
        [Transpose.Template("System.Attribute.getCustomAttributes({element}, {attributeType}, {inherit})")]
