namespace System
{
    ...
    {
        [Transpose.Template("{ Item1: {item1} }")]
        public extern Tuple(T1 item1);

        public extern T1 Item1
        {
            [Transpose.Template("Item1")]
            get;
        }

        [Transpose.Template("Transpose.objectEquals({this}, {o}, true)")]
        public override extern bool Equals(object o);

        [Transpose.Template("Transpose.getHashCode({this}, false, true)")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3}, Item4: {item4} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3}, Item4: {item4}, Item5: {item5} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3}, Item4: {item4}, Item5: {item5}, Item6: {item6} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3}, Item4: {item4}, Item5: {item5}, Item6: {item6}, Item7: {item7} }")]
    ...
    {
        [Transpose.Template("{ Item1: {item1}, Item2: {item2}, Item3: {item3}, Item4: {item4}, Item5: {item5}, Item6: {item6}, Item7: {item7}, rest: {rest} }")]
