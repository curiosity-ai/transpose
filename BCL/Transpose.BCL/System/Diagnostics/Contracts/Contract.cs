...
namespace System.Diagnostics.Contracts
{
    ...
    public static class Contract
    {
        ...
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(5, this, function () { return {condition}; })")]
        ...
        [Pure]
        [Conditional("DEBUG"), Conditional("CONTRACTS_FULL")]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(5, this, function () { return {condition}; }, {userMessage})")]
        ...
        [Pure]
        [Conditional("DEBUG"), Conditional("CONTRACTS_FULL")]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(4, this, function () { return {condition}; })")]
        ...
        [Pure]
        [Conditional("DEBUG"), Conditional("CONTRACTS_FULL")]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(4, this, function () { return {condition}; }, {userMessage})")]
        ...
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(0, this, function () { return {condition}; })")]
        ...
        [Pure]
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.assert(0, this, function () { return {condition}; }, {userMessage})")]
        ...
        /// </remarks>
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.requires({TException}, this, function () { return {condition}; })")]
        ...
        /// </remarks>
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.requires({TException}, this, function () { return {condition}; }, {userMessage})")]
        ...
        [Pure]
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("0 /*{condition}*/")]
        public static extern void Ensures(bool condition);
        ...
        [Pure]
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("0 /*{condition} {userMessage}*/")]
        public static extern void Ensures(bool condition, string userMessage);
        ...
        [Pure]
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("0 /*{TException} {condition}*/")]
        public static extern void EnsuresOnThrow<TException>(bool condition) where TException : Exception;
        ...
        [Pure]
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("0 /*{TException} {condition} {userMessage}*/")]
        public static extern void EnsuresOnThrow<TException>(bool condition, string userMessage) where TException : Exception;
        ...
        /// </remarks>
        [Pure]
        [Transpose.Template("0 /*{T}*/")]
        public static extern T Result<T>();
        ...
        /// </remarks>
        [Pure]
        [Transpose.Template("0 /*{T} {value}*/")]
        public static extern T ValueAtReturn<T>(out T value);
        ...
        [Pure]
        [Transpose.Template("0 /*{T} {value}*/")]
        public static extern T OldValue<T>(T value);
        ...
        [Conditional("CONTRACTS_FULL")]
        [Transpose.Template("0 /*{condition}*/")]
        public static extern void Invariant(bool condition);
        ...
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.forAll({fromInclusive}, {toExclusive}, {predicate})")]
        ...
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.forAll$1({collection}, {predicate})")]
        ...
        /// starting from <paramref name="fromInclusive"/> to <paramref name="toExclusive"/> - 1.</returns>
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.exists({fromInclusive}, {toExclusive}, {predicate})")]
        ...
        /// <paramref name="collection"/>.</returns>
        [Pure]
        [Transpose.Template("System.Diagnostics.Contracts.Contract.exists$1({collection}, {predicate})")]
        ...
        public static extern void EndContractBlock();
